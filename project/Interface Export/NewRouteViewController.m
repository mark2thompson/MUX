...
- (void)viewDidLoad {
  ...
  UITabBarItem *tabBarItem1 = [[[UITabBarItem alloc] initWithTitle:@"Fish on" image:[UIImage imageNamed:@"NewRouteViewController_Image_1.png"] tag:1] autorelease];
  ...
  UITabBarItem *tabBarItem2 = [[[UITabBarItem alloc] initWithTitle:@"Stop" image:[UIImage imageNamed:@"NewRouteViewController_Image_2.png"] tag:2] autorelease];
  ...
  UITabBarItem *tabBarItem3 = [[[UITabBarItem alloc] initWithTitle:@"Conditions" image:[UIImage imageNamed:@"NewRouteViewController_Image_3.png"] tag:3] autorelease];
  ...
  [imageButton1 setImage:[UIImage imageNamed:@"NewRouteViewController_Image_4.png"] forState:UIControlStateNormal];
...
- (void)didTap_tabBarItem3 {
  ConditionsWithNavViewController *controller = [[ConditionsWithNavViewController alloc] init];
  [self.navigationController pushViewController:controller animated:NO];
  [controller release];
}

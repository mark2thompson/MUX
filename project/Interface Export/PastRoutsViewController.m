...
- (void)viewDidLoad {
  ...
  UITabBarItem *tabBarItem1 = [[[UITabBarItem alloc] initWithTitle:@"Past Routes" image:[UIImage imageNamed:@"PastRoutsViewController_Image_1.png"] tag:1] autorelease];
  ...
  UITabBarItem *tabBarItem2 = [[[UITabBarItem alloc] initWithTitle:@"New" image:[UIImage imageNamed:@"PastRoutsViewController_Image_2.png"] tag:2] autorelease];
  ...
  UITabBarItem *tabBarItem3 = [[[UITabBarItem alloc] initWithTitle:@"Conditions" image:[UIImage imageNamed:@"PastRoutsViewController_Image_3.png"] tag:3] autorelease];
  ...
  [imageButton1 setImage:[UIImage imageNamed:@"PastRoutsViewController_Image_4.png"] forState:UIControlStateNormal];
  ...
  tableView1.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"PastRoutsViewController_Image_5.png"]];
  [tableView1 release];

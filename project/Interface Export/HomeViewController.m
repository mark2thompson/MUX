...
- (void)viewDidLoad {
  ...
  UITabBarItem *tabBarItem1 = [[[UITabBarItem alloc] initWithTitle:@"Past Routes" image:[UIImage imageNamed:@"HomeViewController_Image_1.png"] tag:1] autorelease];
  ...
  UITabBarItem *tabBarItem2 = [[[UITabBarItem alloc] initWithTitle:@"New" image:[UIImage imageNamed:@"HomeViewController_Image_2.png"] tag:2] autorelease];
  ...
  UITabBarItem *tabBarItem3 = [[[UITabBarItem alloc] initWithTitle:@"Conditions" image:[UIImage imageNamed:@"HomeViewController_Image_3.png"] tag:3] autorelease];
  ...
  [imageButton1 setImage:[UIImage imageNamed:@"HomeViewController_Image_4.png"] forState:UIControlStateNormal];
